...
> **Last updated:** 2026-06-01 (refresh #17)
...
> 🔒 Claude Mythos Preview (Project Glasswing) — restricted access only; no public API; general release expected "in coming weeks" per May 28 announcement
> 🚨 **Opus 4.7 moved to Legacy (May 28, 2026)** — migrate to Opus 4.8 (same price, improved capabilities)
> ⚠️ **Claude Sonnet 4 + Opus 4 retiring June 15, 2026** — migrate to Sonnet 4.6 / Opus 4.8 before that date
...
> 🚨 **GPT-5.2 Thinking retires June 5, 2026** — migrate immediately (4 days away from June 1)
...
> 🆕 **Voxtral Mini** — 3B lightweight ASR at $0.001/min audio (4× cheaper than Voxtral Small); June 1 confirmed on pricing page
> 🆕 **Voxtral Mini Transcribe** — $0.002/min transcription endpoint; released May 15, 2026
...
|---|---|---|---|
| Anthropic | 1 | [anthropic.md](./anthropic.md) | Full model cards incl. Opus 4.8 (flagship), Sonnet 4.6, Haiku 4.5; retirement date corrections for Sonnet 4 + Opus 4 |
| OpenAI | 1 | [openai.md](./openai.md) | Full model cards incl. GPT-5.5 Priority tier, reasoning models, GPT-5.2 Thinking retirement warning |
...
| Mistral AI | 1 | [mistral.md](./mistral.md) | Full model cards incl. Voxtral Mini + Voxtral Mini Transcribe (new), Mixtral API models, all price corrections |
...
| ⚠️ Claude Sonnet 4 | **DEPRECATED · Retiring June 15, 2026** *(still API-accessible until then — previous entry incorrectly said RETIRED April 20)* | $3.00 | $15.00 | → Claude Sonnet 4.6 — **migrate before June 15** |
| ⚠️ Claude Opus 4 | **DEPRECATED · Retiring June 15, 2026** *(still API-accessible until then — previous entry incorrectly said RETIRED April 20)* | $15.00 | $75.00 | → Claude Opus 4.8 — **migrate before June 15** |
...
| ⚠️ GPT-5.2 | LEGACY · Retiring Jun 2026 (Thinking: **June 5 — IMMINENT**) | $1.75 | $14.00 | → GPT-5.4 or GPT-5.5 |
...
| 2026-06-01 | OpenAI | **GPT-5.2 Thinking** | 🚨 RETIREMENT IMMINENT — GPT-5.2 Thinking variant retires **June 5, 2026** (4 days from June 1). Migrate to GPT-5.4 or GPT-5.5 immediately. |
| 2026-06-01 | Mistral | **Voxtral Mini** | 🆕 ADDED — New model now listed on official `mistral.ai/pricing`. 3B lightweight audio understanding model. Audio input: **$0.001/min**; text input: **$0.04/MTok**; output: **$0.04/MTok**. Model ID: `voxtral-mini-latest`. Apache 2.0 open-weight. 4× cheaper than Voxtral Small for audio input. |
| 2026-06-01 | Mistral | **Voxtral Mini Transcribe** | 🆕 ADDED — Transcription-optimized endpoint of Voxtral Mini, released May 15, 2026. Pricing: **$0.002/min** (official Mistral page; OpenRouter shows $0.003/min). Model ID: `voxtral-mini-latest` transcription endpoint. Supports diarization, 13 languages. |
| 2026-06-01 | Mistral | **Mixtral 8x7B + 8x22B (API)** | 📝 DOCUMENTED — Both models confirmed active on `mistral.ai/pricing` with API pricing. 8x7B: **$0.70/$0.70** per MTok. 8x22B: **$2.00/$6.00** per MTok. Added to active models table (legacy generation, prefer Ministral 3 family for new projects). |
| 2026-06-01 | OpenAI | **All active models** | ✅ RE-VERIFIED — All prices confirmed unchanged since May 28, 2026. Source: openai.com/api/pricing/. |
| 2026-06-01 | Anthropic | **All active models** | ✅ RE-VERIFIED — Opus 4.8 $5/$25, Sonnet 4.6 $3/$15, Haiku 4.5 $1/$5 confirmed unchanged. Source: claude.com/pricing#api. |
| 2026-06-01 | Mistral | **All active models (except new additions)** | ✅ RE-VERIFIED — All prices confirmed unchanged since May 28, 2026. Source: mistral.ai/pricing. |
| 2026-05-28 | Anthropic | **Claude Opus 4.8** | 🚨 LAUNCHED — New active flagship. Model ID `claude-opus-4-8`. $5/$25 per MTok (same as Opus 4.7). Fast Mode: 2× standard ($10/$50) for up to 2.5× speed. Context: 1M tokens (200k on MS Foundry). Max output: 128k sync / 300k Batch. Adaptive thinking ✅, Extended thinking ❌. |
...
| 2026-05-28 | Mistral | **Pixtral Large** | ⚠️ MOVED TO LEGACY — No longer listed on `mistral.ai/pricing`. Confirmed in `docs.mistral.ai` legacy table. |
...
- 🚨 **URGENT June 2026 deadlines:** Gemini 2.0 Flash shutdown June 1 · GPT-5.2 Thinking retires June 5 · Claude Sonnet 4 + Opus 4 retire June 15
- 🔁 **Correction (June 1, 2026):** Claude Sonnet 4 and Opus 4 retirement date was previously recorded as April 20, 2026 — this was incorrect. The official Anthropic deprecation announcement sets retirement on June 15, 2026. Both models remain API-accessible until that date.
- 🆕 **New Mistral models (June 1, 2026):** Voxtral Mini ($0.001/min audio) and Voxtral Mini Transcribe ($0.002/min) added; Mixtral 8x7B/8x22B documented as active API models.
