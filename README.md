...
|---|---|---|---|---|---|
| GPT-5.4 | $2.50 | $0.25 | $15.00 | 1.05M tokens | API |
| GPT-5.4 mini | $0.75 | — | $4.50 | 400K tokens | API |
| GPT-5.4 nano | $0.20 | — | $1.25 | 400K tokens | API |
| GPT-5.2 | $1.75 | $0.18 | $14.00 | 400K tokens | API |
...
| Ministral 8B | $0.15 | $0.15 | 256K tokens | API (Mistral AI Studio) |
